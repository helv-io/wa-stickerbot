...
export const react = async (message: proto.IWebMessageInfo, emoji: string) => {
...
export const makeSticker = async (message: proto.IWebMessageInfo) => {
    message.key.remoteJid = message.key.remoteJid || ''
...
export interface baileysClient {
    ...
    getCatalog: ({ jid, limit, cursor }: import('@adiwajshing/baileys/lib/Types').GetCatalogOptions) => Promise<{
    ...
    relayMessage: (jid: string, message: import('@adiwajshing/baileys/lib/Types').WAProto.IMessage, { messageId, participant, additionalAttributes, useUserDevicesCache, cachedGroupMetadata }: import('@adiwajshing/baileys/lib/Types').MessageRelayOptions) => Promise<string>;
    sendReceipt: (jid: string, participant: string | undefined, messageIds: string[], type: import('@adiwajshing/baileys/lib/Types').MessageReceiptType) => Promise<void>;
    sendReceipts: (keys: import('@adiwajshing/baileys/lib/Types').WAProto.IMessageKey[], type: import('@adiwajshing/baileys/lib/Types').MessageReceiptType) => Promise<void>;
    ...
    updateMediaMessage: (message: import('@adiwajshing/baileys/lib/Types').WAProto.IWebMessageInfo) => Promise<import('@adiwajshing/baileys/lib/Types').WAProto.IWebMessageInfo>;
    sendMessage: (jid: string, content: import('@adiwajshing/baileys/lib/Types').AnyMessageContent, options?: import('@adiwajshing/baileys/lib/Types').MiscMessageGenerationOptions) => Promise<import('@adiwajshing/baileys/lib/Types').WAProto.WebMessageInfo | undefined>;
    ...
    groupAcceptInviteV4: (key: string | import('@adiwajshing/baileys/lib/Types').WAProto.IMessageKey, inviteMessage: import('@adiwajshing/baileys/lib/Types').WAProto.Message.IGroupInviteMessage) => Promise<string>;
    groupGetInviteInfo: (code: string) => Promise<import('@adiwajshing/baileys/lib/Types').GroupMetadata>;
    ...
    upsertMessage: (msg: import('@adiwajshing/baileys/lib/Types').WAProto.IWebMessageInfo, type: import('@adiwajshing/baileys/lib/Types').MessageUpsertType) => Promise<void>;
    appPatch: (patchCreate: import('@adiwajshing/baileys/lib/Types').WAPatchCreate) => Promise<void>;
    sendPresenceUpdate: (type: import('@adiwajshing/baileys/lib/Types').WAPresence, toJid?: string | undefined) => Promise<void>;
    ...
    ev: import('@adiwajshing/baileys/lib/Types').BaileysEventEmitter & {
        process(handler: (events: Partial<import('@adiwajshing/baileys/lib/Types').BaileysEventMap>) => void | Promise<void>): () => void;
        buffer(): void;
        createBufferedFunction<A extends unknown[], T_1>(work: (...args: A) => Promise<T_1>): (...args: A) => Promise<T_1>;
    ...
    waitForMessage: (msgId: string, timeoutMs?: number | undefined) => Promise<unknown>;
    ...
    waitForConnectionUpdate: (check: (u: Partial<import('@adiwajshing/baileys/lib/Types').ConnectionState>) => boolean | undefined, timeoutMs?: number | undefined) => Promise<void>;
}