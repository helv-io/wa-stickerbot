    ...
    void client.onMessage(function (message) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_u) {
            switch (_u.label) {
                ...
                case 3:
                    _u.trys.push([3, 5, , 7]);
                    return [4 /*yield*/, client.sendVideoAsGif(message.from, media.dataURL, media.filename, media.filename)];
                case 4:
                    _u.sent();
                    return [3 /*break*/, 7];
                case 5:
                    _a = _u.sent();
                    return [4 /*yield*/, client.sendImage(message.from, media.dataURL, media.filename, media.filename)];
                case 6:
                    _u.sent();
                    return [3 /*break*/, 7];
