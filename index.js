...
var start = function (client) {
  ...
  void client.onAnyMessage(function (message) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              client.sendMp4AsSticker(message.from, dataURL, videoOpts, meta),
            ];
          case 4:
            void _b.sent();
            return [3 /*break*/, 7];
...
void wa_automate_1.create(config).then(function (client) {
  return start(client);
});
