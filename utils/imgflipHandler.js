...
exports.getImgflipMemes = exports.getImgflipList = exports.getImgflipImage = void 0;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!meme) return [3 /*break*/, 3];
                config_1.imgflip.template_id = meme.id;
                config_1.imgflip.boxes = [];
...
exports.getImgflipImage = getImgflipImage;
var getImgflipList = function () { return __awaiter(void 0, void 0, void 0, function () {
    var memes, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
exports.getImgflipList = getImgflipList;
var getImgflipMemes = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios_1.default.get(imgflipGetMemesURL)];
            case 1: return [2 /*return*/, (_a.sent()).data.data.memes];
        }
    });
}); };
exports.getImgflipMemes = getImgflipMemes;
